...
import lth_pruning.lth_cal_TCAV as tcav
...
def run_mnist():
    print("TCAV calculation for MNIST")
    # parse arguments
...
def run_CUB():
    print("TCAV calculation for CUB")
    # parse arguments
    parser = argparse.ArgumentParser()
    parser.add_argument(
    ...
    # print("-np.array(concept_model.coef_)")
    # print("np.dot(flatten_gradients, cav) < 0")
    tcav.cal_TCAV_w_pruning_multiclass(
        _seed,
        _data_root,
        _json_root,
        _model_arch,
